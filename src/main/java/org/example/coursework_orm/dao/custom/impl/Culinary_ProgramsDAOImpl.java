...
public class Culinary_ProgramsDAOImpl implements Culinary_ProgramsDAO {
    ...
    public List<Culinary_Programs> getAll() throws SQLException {
        ...
        List<Culinary_Programs>culinaryProgramsList= session.createQuery("FROM org.example.coursework_orm.entity.Culinary_Programs", Culinary_Programs.class).list();
    ...
    public List<String> getIds() throws SQLException {
        ...
        List<String> idList = session.createQuery("SELECT cp.programID FROM org.example.coursework_orm.entity.Culinary_Programs cp", String.class).list();
