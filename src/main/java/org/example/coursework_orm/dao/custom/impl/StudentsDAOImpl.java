...
public class StudentsDAOImpl implements StudentsDAO {
    ...
    public List<Students> getAll() throws SQLException {
        ...
        List<Students>studentsList= session.createQuery("FROM org.example.coursework_orm.entity.Students", Students.class).list();
    ...
    public List<String> getIds() throws SQLException {
        ...
        List<String> idList = session.createQuery("SELECT s.studentID FROM org.example.coursework_orm.entity.Students s", String.class).list();
    ...
    public String getCurrentStudentID() throws SQLException {
        ...
        String hql = "SELECT s.studentID FROM org.example.coursework_orm.entity.Students s ORDER BY s.studentID DESC";
